...
function buildPoolConfig() {
  ...
  return {
    ...
    database: process.env.PGDATABASE || process.env.POSTGRES_DB       || process.env.DATABASE_NAME || "lead_intelligence",
    user:     process.env.PGUSER     || process.env.POSTGRES_USER     || process.env.DATABASE_USER || "lead_admin",

...
test('detectIndustry - uses explicit industry field when no keyword match', () => {
  const result = detectIndustry({ company_name: 'ABC Company', industry: 'Industrial' });
...
test('generateReport - returns correct summary', () => {
  const leads = [
    {
      company_name: 'A', city: 'Columbus', lead_score: 80, tier: 'HOT',
      industry: 'Epoxy', industry_detected: 'Epoxy'
    },
    {
      company: 'B', city: 'Tempe', lead_score: 55, tier: 'WARM',
      industry: 'Concrete', industry_detected: 'Concrete'
    },
    {
      company: 'C', city: 'Detroit', lead_score: 20, tier: 'COLD',
      industry: 'Unknown', industry_detected: 'Unknown'
    }
  ];

...
app.get('/', (_req, res) => {
  res.json({
    ...
    version: '1.0.0',
    description: 'Shadow headless browser agent with Playwright. Supports form fill, scroll, type, click, screenshot, navigation, and parallel sessions.',
    endpoints: {
...
server = app.listen(PORT, () => {
  ...
  console.log(`[HeadlessAgent] Max parallel sessions: ${process.env.HEADLESS_MAX_SESSIONS || 10}`);
});

// Centralized SVG icon set — Heroicons outline style, stroke-width 1.75
// All icons accept optional className prop for sizing/color
  ...
  return (
    ...
    >
      <path
        ...
        strokeLinejoin="round"
        strokeWidth={1.75}
        d="M9 3H7a2 2 0 00-2 2v14a2 2 0 002 2h10a2 2 0 002-2V5a2 2 0 00-2-2h-2M9 3a1 1 0 000 2h6a1 1 0 100-2M9 3H7m2 0h6m-3 9h.01M12 17h.01M8 12h.01M16 12h.01M8 17h.01M16 17h.01"
      />
    </svg>
  );
}
...
export function IconFire({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function IconSnowflake({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function IconTarget({ className = "w-5 h-5" }: IconProps) {
  return (
    ...
    >
      ...
      <circle cx="12" cy="12" r="1" strokeWidth={1.75} />
    </svg>
  );
}
...
export function IconArrowUp({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"
...
export function IconList({ className = "w-5 h-5" }: IconProps) {
  return (
    <svg
      className={className}
      fill="none"

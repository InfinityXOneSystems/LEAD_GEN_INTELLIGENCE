...
import { IconMail, IconGitHub, IconCpu, IconStar, IconSettings, IconGlobe, IconBarChart, IconFolder, IconClock } from "@/components/Icons";
  ...
  return (
    <div className="space-y-6 fade-in">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-4">
        ...
        {/* GitHub */}
        <SectionCard title="GitHub Connector" icon={<IconGitHub className="w-5 h-5" />}>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
                <div className="text-sm text-white">Status</div>
        ...
        {/* Copilot */}
        <SectionCard title="GitHub Copilot" icon={<IconStar className="w-5 h-5" />}>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
        ...
        {/* Google Workspace */}
        <SectionCard title="Google Workspace" icon={<IconGlobe className="w-5 h-5" />}>
          <div className="space-y-3">
            <div className="flex items-center justify-between">
              <div>
            ...
            <div className="bg-[#111111] rounded-lg p-3 text-xs space-y-1.5">
              ...
              {[
                { icon: <IconMail className="w-3.5 h-3.5" />, name: "Gmail", desc: "Outreach email sending" },
                { icon: <IconBarChart className="w-3.5 h-3.5" />, name: "Sheets", desc: "Lead export to spreadsheet" },
                { icon: <IconFolder className="w-3.5 h-3.5" />, name: "Drive", desc: "Report backup & storage" },
                { icon: <IconClock className="w-3.5 h-3.5" />, name: "Calendar", desc: "Schedule scraping events" },
              ].map((svc) => (
        ...
        <SectionCard title="Google Sheets Export" icon={<IconBarChart className="w-5 h-5" />}>
          <div className="space-y-3">
            <div className="text-xs text-gray-500">
        ...
        <SectionCard title="Copilot Mobile + GPT Actions" icon={<IconSettings className="w-5 h-5" />}>
          <div className="space-y-3">
            <div className="text-xs text-gray-500">

...
const SAMPLE_LEADS = [
  { id: 1,  company: 'ProEpoxy Solutions',       contact: 'Mark Rivera',   phone: '(614) 555-0101', email: 'mark@proepoxy.com',      website: 'proepoxy.com',       city: 'Columbus',      state: 'OH', industry: 'Epoxy',       services: 'Garage Epoxy, Commercial',   rating: 4.8, reviews: 142, score: 88, status: 'qualified',  date: '2025-03-01' },
  { id: 2,  company: 'Concrete Masters LLC',     contact: 'Sarah Kim',     phone: '(480) 555-0192', email: 'sarah@concretemasters.com', website: 'concretemasters.com', city: 'Tempe',        state: 'AZ', industry: 'Concrete',    services: 'Polishing, Sealing',         rating: 4.5, reviews: 98,  score: 76, status: 'contacted',  date: '2025-03-01' },
  { id: 3,  company: 'GlossFloor Chicago',       contact: 'David Park',    phone: '(312) 555-0345', email: '',                          website: '',                    city: 'West Chicago',  state: 'IL', industry: 'Epoxy',       services: 'Metallic Epoxy, Industrial', rating: 4.2, reviews: 55,  score: 52, status: 'new',        date: '2025-03-02' },
  { id: 4,  company: 'OKC Floor Systems',        contact: 'Lisa Moore',    phone: '(405) 555-0567', email: 'lisa@okcfloor.com',         website: 'okcfloor.com',        city: 'Oklahoma City', state: 'OK', industry: 'Concrete',    services: 'Repair, Resurfacing',        rating: 4.6, reviews: 77,  score: 71, status: 'contacted',  date: '2025-03-02' },
  { id: 5,  company: 'SurfacePro FL',            contact: 'James White',   phone: '(954) 555-0789', email: 'james@surfacepro.com',      website: 'surfacepro.com',      city: 'Pompano Beach', state: 'FL', industry: 'SurfacePrep', services: 'Shot Blasting, Grinding',    rating: 4.9, reviews: 213, score: 94, status: 'converted', date: '2025-02-28' },
  { id: 6,  company: 'Midwest Resin Works',      contact: 'Tom Hansen',    phone: '',               email: '',                          website: '',                    city: 'Columbus',      state: 'OH', industry: 'Epoxy',       services: 'Decorative Epoxy',           rating: 3.8, reviews: 22,  score: 31, status: 'new',        date: '2025-03-03' },
  { id: 7,  company: 'Arizona Polished Concrete',contact: 'Elena Cruz',    phone: '(602) 555-0234', email: 'elena@azpolished.com',      website: 'azpolished.com',      city: 'Tempe',        state: 'AZ', industry: 'Concrete',    services: 'Staining, Polishing',        rating: 4.7, reviews: 89,  score: 82, status: 'qualified',  date: '2025-03-03' },
  { id: 8,  company: 'FlakeFloor Inc.',          contact: 'Ryan Scott',    phone: '(614) 555-0891', email: 'ryan@flakefloor.com',       website: 'flakefloor.com',      city: 'Columbus',      state: 'OH', industry: 'Epoxy',       services: 'Flake Epoxy, Polyaspartic',  rating: 4.4, reviews: 67,  score: 73, status: 'new',        date: '2025-03-04' },
  { id: 9,  company: 'IL Concrete Co.',          contact: 'Nancy Bell',    phone: '(630) 555-0123', email: 'nancy@ilconcrete.com',      website: 'ilconcrete.com',      city: 'West Chicago',  state: 'IL', industry: 'Concrete',    services: 'Sealing, Resurfacing',       rating: 4.3, reviews: 44,  score: 65, status: 'contacted',  date: '2025-03-04' },
  { id: 10, company: 'ToughCoat Flooring',       contact: 'Chris Adams',   phone: '(954) 555-0456', email: 'chris@toughcoat.com',       website: 'toughcoat.com',       city: 'Pompano Beach', state: 'FL', industry: 'Epoxy',       services: 'Polyurea, Commercial',       rating: 4.6, reviews: 101, score: 80, status: 'qualified',  date: '2025-03-04' },
  { id: 11, company: 'Grind & Shine LLC',        contact: 'Amy Foster',    phone: '(405) 555-0678', email: 'amy@grindshine.com',        website: 'grindshine.com',      city: 'Oklahoma City', state: 'OK', industry: 'SurfacePrep', services: 'Diamond Grinding',           rating: 4.1, reviews: 30,  score: 58, status: 'new',        date: '2025-03-05' },
  { id: 12, company: 'LevelUp Concrete',         contact: 'Kevin Turner',  phone: '(312) 555-0567', email: '',                          website: '',                    city: 'West Chicago',  state: 'IL', industry: 'Concrete',    services: 'Decorative, Stamping',       rating: 3.9, reviews: 18,  score: 28, status: 'new',        date: '2025-03-05' },
  { id: 13, company: 'ResinPros AZ',             contact: 'Olivia Lane',   phone: '(480) 555-0345', email: 'olivia@resinpros.com',      website: 'resinpros.com',       city: 'Tempe',        state: 'AZ', industry: 'Epoxy',       services: 'Metallic Epoxy, Residential',rating: 4.8, reviews: 156, score: 91, status: 'converted', date: '2025-02-27' },
  { id: 14, company: 'BlastMasters Corp',        contact: 'Derek Hughes',  phone: '(877) 555-0001', email: 'derek@blastmasters.com',    website: 'blastmasters.com',    city: 'Pompano Beach', state: 'FL', industry: 'SurfacePrep', services: 'Shot Blasting, Industrial',  rating: 4.5, reviews: 72,  score: 74, status: 'qualified',  date: '2025-03-01' },
  { id: 15, company: 'TopCoat OH',               contact: 'Samantha Vega', phone: '(614) 555-0999', email: 'sam@topcoatoh.com',         website: 'topcoatoh.com',       city: 'Columbus',      state: 'OH', industry: 'Epoxy',       services: 'Garage, Decorative Epoxy',   rating: 4.7, reviews: 188, score: 87, status: 'qualified',  date: '2025-03-02' },
];
    ...
    state.charts.status = new Chart(statusCtx, {
      ...
      data: {
        ...
        datasets: [{
          ...
          borderColor:      ['rgb(59,130,246)',      'rgb(245,158,11)',      'rgb(16,185,129)',      'rgb(139,92,246)'],
          borderWidth: 1,
          borderRadius: 4,
        }],
      },
    ...
    state.charts.scoreDist = new Chart(scoreDistCtx, {
      ...
      data: {
        ...
        datasets: [{
          label: 'Leads',
          data: bucketCounts,
          backgroundColor: ['rgba(239,68,68,0.7)', 'rgba(245,158,11,0.7)', 'rgba(59,130,246,0.7)', 'rgba(16,185,129,0.7)', 'rgba(16,185,129,0.9)'],
          borderWidth: 0,
          borderRadius: 4,
        }],
      },
...
function runCommand(cmd) {
  ...
  if (parts[0] === 'help') {
    ...
    COMMANDS_HELP.forEach(c => termPrint(`  ${c.cmd.padEnd(22)} ${c.desc}`, 'output'));
    ...
    if (state.leads.length > 10) termPrint(`  … and ${state.leads.length - 10} more`, 'comment');

  } else if (parts[0] === 'leads' && parts[1] === 'status') {
    const s = parts[2];
    const filtered = s ? state.leads.filter(l => l.status === s) : state.leads;
    if (!s) { termPrint('Usage: leads status <new|contacted|qualified|converted>', 'warning'); return; }
    if (filtered.length === 0) { termPrint(`No leads with status "${s}"`, 'warning'); return; }
...
function bindEvents() {
  ...
  if (filterStatus)   filterStatus.addEventListener('change',   e => { state.filterStatus   = e.target.value; applyFilters(); renderTable(); });
  if (filterIndustry) filterIndustry.addEventListener('change', e => { state.filterIndustry = e.target.value; applyFilters(); renderTable(); });
  if (filterState)    filterState.addEventListener('change',    e => { state.filterState    = e.target.value; applyFilters(); renderTable(); });
  if (searchInput)    searchInput.addEventListener('input',     e => { state.searchQuery    = e.target.value; applyFilters(); renderTable(); });

  // Top-bar search (mirrors the leads tab search)
  const topbarSearch = document.getElementById('topbarSearch');
  if (topbarSearch) topbarSearch.addEventListener('input', e => {
